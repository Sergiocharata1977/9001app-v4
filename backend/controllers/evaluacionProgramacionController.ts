...
const getProgramaciones = async (req: Request, res: Response, next?: NextFunction): void => {
...
const createProgramacion = async (req: Request, res: Response, next?: NextFunction): void => {
...
const getProgramacionById = async (req: Request, res: Response, next?: NextFunction): void => {
  const { organization_id } = req.user;
  const { id } = req.params;
...
const updateProgramacion = async (req: Request, res: Response, next?: NextFunction): void => {
  const { organization_id } = req.user;
  const { id } = req.params;
  const { titulo, nombre, descripcion, fecha_inicio, fecha_fin, estado } = req.body;
...
const deleteProgramacion = async (req: Request, res: Response, next?: NextFunction): void => {
  const { organization_id } = req.user;
  const { id } = req.params;
