...
// @access  Privado
const getAllEvents = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
...
// @access  Privado
const createEvent = async (req: Request, res: Response, next?: NextFunction): void => {
...
// @access  Privado
const updateEvent = async (req: Request, res: Response, next?: NextFunction): void => {
  const { id } = req.params;
  const { title, description, start_time, end_time, all_day, type } = req.body;
...
// @access  Privado
const deleteEvent = async (req: Request, res: Response, next?: NextFunction): void => {
  const { id } = req.params;
  const { organization_id } = req.user;
