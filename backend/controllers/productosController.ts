...
// @access  Private
const getProductos = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
...
// @access  Private
const getProducto = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
    const organization_id = req.user?.organization_id;
...
// @access  Private
const createProducto = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const organization_id = req.user?.organization_id;
    const {
...
// @access  Private
const updateProducto = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
    const organization_id = req.user?.organization_id;
    const {
...
// @access  Private
const deleteProducto = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
    const organization_id = req.user?.organization_id;
...
// @access  Private
const getHistorialProducto = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
    const organization_id = req.user?.organization_id;
