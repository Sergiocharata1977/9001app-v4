...
const getEncuestas = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
...
const createEncuesta = async (req: Request, res: Response, next?: NextFunction): void => {
...
const getEncuesta = async (req: Request, res: Response, next?: NextFunction): void => {
  const { id } = req.params;
  try {
    const result = await mongoClient.execute({
      sql: 'SELECT * FROM encuestas WHERE id = ?',
...
const updateEncuesta = async (req: Request, res: Response, next?: NextFunction): void => {
  const { id } = req.params;
...
const deleteEncuesta = async (req: Request, res: Response, next?: NextFunction): void => {
  const { id } = req.params;
  try {
    const result = await mongoClient.execute({
...
const addRespuesta = async (req: Request, res: Response, next?: NextFunction): void => {
  const { id } = req.params;
