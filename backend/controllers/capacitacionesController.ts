...
const getAllCapacitaciones = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
...
const getCapacitacionById = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
...
const createCapacitacion = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { 
      nombre, 
      descripcion, 
...
const updateCapacitacion = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
    const { 
      nombre, 
...
const deleteCapacitacion = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
...
const getTemasByCapacitacion = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
...
const createTema = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
...
const getAsistentesByCapacitacion = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
...
const addAsistente = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const { id } = req.params;
