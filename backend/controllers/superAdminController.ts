 ...
 */
const getDashboardStats = async (req: Request, res: Response, next?: NextFunction): void => {
 ...
 */
const updateOrganization = async (req: Request, res: Response, next?: NextFunction): void => {
    const client = new mongodb_1.MongoClient(process.env.MONGODB_URI);
    try {
        const { id } = req.params;
 ...
 */
const deleteOrganization = async (req: Request, res: Response, next?: NextFunction): void => {
    const client = new mongodb_1.MongoClient(process.env.MONGODB_URI);
    try {
        const { id } = req.params;
        await client.connect();
 ...
 */
const changeUserRole = async (req: Request, res: Response, next?: NextFunction): void => {
    const client = new mongodb_1.MongoClient(process.env.MONGODB_URI);
    try {
