...
const getOrganizationUsers = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
...
const createOrganizationUser = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const currentUser = req.user;
...
const updateOrganizationUser = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const currentUser = req.user;
...
const deleteOrganizationUser = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const currentUser = req.user;
    const userId = req.params.id;
...
const getAllOrganizations = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const currentUser = req.user;
...
const createOrganization = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const currentUser = req.user;
...
const updateOrganizationPlan = async (req: Request, res: Response, next?: NextFunction): void => {
  try {
    const currentUser = req.user;
