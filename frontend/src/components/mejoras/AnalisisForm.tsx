...
import type { AnalisisFormProps } from '@/types/mejoras';
...
const AnalisisForm: React.FC<AnalisisFormProps> = ({ hallazgoId, onUpdate }) => {
  ...
  const handleSubmit = async (requiereAC: boolean): Promise<void> => {
