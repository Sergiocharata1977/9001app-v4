...
import type { HallazgoCardProps, Hallazgo, HallazgoPrioridad } from '@/types/mejoras';

const getPriorityBadgeClass = (priority: HallazgoPrioridad | undefined): string => {
  switch (priority) {
    case 'Alta':
      ...
      <CardContent className="p-4">
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="default" className={getPriorityBadgeClass(hallazgo.prioridad)}>
              {hallazgo.prioridad}
            </Badge>
          </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                {hallazgo.fechaDeteccion 
                  ? format(new Date(hallazgo.fechaDeteccion), 'dd/MM/yyyy', { locale: es }) 
                  : 'N/A'
                }
              </span>
            </div>
