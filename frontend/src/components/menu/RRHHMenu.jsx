...
const RRHHMenu = ({ onBackToMainMenu }) => {
  ...
  const rrhhModules = [
    ...
    },
    {
      ...
      features: ['Programas de formación', 'Desarrollo profesional', 'Evaluación', 'Seguimiento']
    },
    {
      id: 'evaluaciones',
      title: 'Evaluaciones',
    ...
    },
    {
      id: 'competencias',
      title: 'Competencias',
      subtitle: 'Gestión de Competencias',
      description: 'Definición y evaluación de competencias del personal',
      icon: Award,
      color: 'blue',
      gradient: 'from-blue-500 to-blue-600',
      hoverGradient: 'from-blue-600 to-blue-700',
      path: '/app/rrhh/competencias',
      metrics: {
        competencias: '6',
        activas: '6',
        evaluadas: '0',
      ...
      features: ['Definición de competencias', 'Evaluación', 'Desarrollo', 'Seguimiento']
    }
  ];
