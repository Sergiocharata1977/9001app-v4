...
import { Loader2, Send, Bot, User, Lightbulb, TrendingUp, Database } from 'lucide-react';
...
/**
 * Componente de chat para el sistema RAG con Turso
 */
export const TursoRAGChat: React.FC = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        throw new Error('Error en la consulta RAG');
      }
    } catch (error) {
      ...
      <Card className="mb-4">
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2">
            ...
            Asistente IA - Sistema RAG con Turso
          </CardTitle>
        </CardHeader>
        <CardContent>
          {stats && (
